...
<html>
<head>
<title>Calcolo di un Percorso con API Google Maps - PastuWeb</title>
...
<script type="text/javascript" src="./js/googleCalcPath.js"></script>
    			...
    			<div style="margin:auto;width:810px;" class="content">
	    			<div class="ui-widget-content ui-corner-all" style="border:2px solid #48AA4E;width:250px;height:620px;float:left;">
	    				...
	    				<ul>
	    					...
	    					<li><a style="color:#FF0000;"  href="./calcolaPercorso.php"> Calcola percorso</a></li>
	    				...
	    				<div style="padding:10px;text-align:justify;font-size:13px;">
	    					In questo esempio sono state usate <strong>le API per il calcolo e visualizzazione di un percorso (DA-A)</strong>.
	    				</div>
	    				<div id="directionsPanel" style="height:270px;overflow:auto;">
