...
<html>
<head>
<title>GeoLocalizzazione con API Google Maps - PastuWeb</title>
...
<script type="text/javascript" src="./js/googleGeoLoc.js"></script>
		...
		<div id="corpo" >
			...
			<div id="colonna-2" >
    			...
    			<div style="margin:auto;width:810px;" class="content">
	    			<div class="ui-widget-content ui-corner-all" style="border:2px solid #48AA4E;width:250px;height:600px;float:left;">
	    				<br><br><br><br><br>
	    				...
	    				<ul>
	    					...
	    					<li><a style="color:#FF0000;"  href="./geoLocalizzazione.php"> Geo Localizzazione</a></li>
	    				</ul>
	    				<div style="padding:10px;text-align:justify;font-size:13px;">
	    					In questo esempio sono state utilizzate diverse API in correlazione alla libreria esterna sui Clusters:<br><br>
	    					<strong>Markers, Info Window, Marker Clusterer (libreria di terze parti), Polygon (per disegnare il Piemonte)</strong><br>
	    					Quello che viene visualizzato non &egrave; altro che una mappa con diversi markers. La visualizzazione / creazione dei clusters dipende
	    					dalla distanza dei vari markers, dal numero di markers nelle vicinanze e dallo zoom corrente.<br><br>
	    					Altra cosa visualizzata è un <strong>poligono sul comune di Torino</strong>, sono state prese le coordinate dal sito dell'Istat e poi tutti i punti (ordinati in modalità polare) sono stati uniti da una linea.
	    				</div>
	    			</div>
